...
<body onload="iniMainWindow();">
    ...
    <div class="wrapp-modal hide">
        ...
        <div class="modal-window add-project panel">
            <header class="modal-window__head flex">
                <h3 class="head__title title">Создание проекта</h3>
                <svg class="head__btn-close" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.2875 1.55029L1.38798 11.4498" stroke="#A5A7BC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.38806 1.55029L11.2876 11.4498" stroke="#A5A7BC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <main class="modal-window__content flex f-col">
                <div class="colors-list list-hor flex">
                    <?php include "./php/vendor/getDefaultColors.php"; ?>
                    <div class="user-colors list-hor list-hor__item flex">
                    </div>
                    <div class="color-block-add flex text list-hor__item">
                        <label class="color-block-add__picker" for="color-block__picker">
                            <input type="color" class="color-block__picker" id="color-block__picker" name="color-block__picker" value="#f6b73c">
                            <div class="color-block-add__rect">+</div>
                        </label>
                    </div> 
                </div>
                <div class="fields">
                    <div class="fields__item field flex f-col">
                        <p class="field__title title">Название</p>
                        <input type="text" class="field__input add-project name-project input" placeholder="название проекта">
                        <div class="modal-window__message info flex">
                            <svg class="icon-mess" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 19C14.9706 19 19 14.9706 19 10C19 5.02944 14.9706 1 10 1C5.02944 1 1 5.02944 1 10C1 14.9706 5.02944 19 10 19Z" stroke="#478ECC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M10 6.3999V9.9999" stroke="#478ECC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M10 13.6001H10.01" stroke="#478ECC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg> вы будете руководителем данного проекта
                        </div>
                    </div>
                    <div class="fields__item field flex f-col">
                        <p class="field__title title">Описание</p>
                        <textarea rows="1" type="text" class="field__input add-project descr-project input" placeholder="описание проекта"></textarea>
                    </div>
                </div>
            </main>
            <footer class="modal-window__footer">
        ...
        <div class="modal-window add-target panel">
            <header class="modal-window__head flex">
                <h3 class="head__title title">Создание цели</h3>
                <svg class="head__btn-close" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.2875 1.55029L1.38798 11.4498" stroke="#A5A7BC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.38806 1.55029L11.2876 11.4498" stroke="#A5A7BC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <main class="modal-window__content flex f-col">
                ...
                <div class="fields">
                    <div class="fields__item group-fields flex">
                        <div class="fields__item group-fields__item field flex f-col">
                            <p class="field__title title">Проект</p>
                            <select id="projects-target" class="custom-select projects-target projects text">
                                <?php include "php/getProjects.php"; ?>
                            </select>
                        </div>
                        <div class="group-fields__subgroup flex">
                            <div class="fields__item group-fields__item field flex f-col">
                                <p class="field__title title">Команды</p>
                                <div class="wrapper-teams flex">
                                    <div class="wrapper-teams__item select-activity" data="default-select">
                                        <select id="activities-target-1" class="custom-select activities-target activities text">
                                            <?php include "php/getActivities.php"; ?>
                                        </select>
                                    </div>
                                    <button class="button small" id="add-team-act">+</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fields__item field flex f-col">
                        <p class="field__title title">Название</p>
                        <input type="text" class="field__input add-target name-target input" placeholder="название цели">
                    </div>
                    <div class="fields__item field flex f-col">
                        <p class="field__title title">Описание</p>
                        <textarea rows="1" type="text" class="field__input add-target descr-target input" placeholder="описание проекта"></textarea>
                    </div>
                </div>
            </main>
            <footer class="modal-window__footer">
        ...
        <nav class="menu panel tabs-triggers">
            ...
            <ul>
                <li value="tab-1" class="tabs-triggers__item flex">
                    <svg class="svg-stroke-menu" width="22" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li value="tab-2" class="tabs-triggers__item flex">
                    <svg class="svg-stroke-menu" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li value="tab-3" class="tabs-triggers__item flex">
                    <svg class="svg-stroke-menu" width="23" height="30" viewBox="0 0 23 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li value="tab-4" class="tabs-triggers__item flex">
                    <svg class="svg-fill-menu" width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li value="tab-5" class="tabs-triggers__item flex">
                    <svg class="svg-fill-menu" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <header class="task-data__header flex">
                            ...
                            <div class="header-actions flex list-hor">
                                <label for="area-files__input" class="flex list-hor__item">
                                    <svg class="add-attach svg-stroke" width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg class="add-subtasks svg-stroke list-hor__item" width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg class="delete-task svg-stroke list-hor__item" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <main class="task-data__main">
                            ...
                            <section class="wrapp-content">
                                <div class="task-data__content task-content">
                                    <textarea rows="1" type="text" class="task-content__text input title" spellcheck="false" wrap="soft" placeholder="текст"></textarea>
                                    <textarea rows="1" class="task-content__description text regular" spellcheck="false" wrap="soft" placeholder="описание"></textarea>
            ...
            <div id="tab-3" class="tabs-content__item">
                <section class="projects-area grid-area">
                    <div class="projects-head grid-area__header flex">
                        ...
                        <button class="button small" id="add-project">+</button></div>
                ...
                <section class="targets-area grid-area">
                    <div class="targets-head grid-area__header flex">
                        ...
                        <button class="button small" id="add-target">+</button>
                    </div>
                    <div class="targets-list list-hor-big flex">
                    </div>
                    <div class="user-panel flex">
                        <div class="user-panel-wrapper flex">
                            <div class="user-data flex f-col">
                        ...
                        <div class="data-block attach-block panel list-hor-big__item">
                                ...
                                <div class="content-wrapper__item main-data">
                                    <header class="attach-block__header block-head flex">
                                        <div class="user-select-data flex">
                                            <div style="background-image:url(pictures/users_avatar/default-avatar.svg); background-position: center; background-size: contain;" class="user-select-avatar">
                                            </div>
                                            <div class="flex f-col">
                                                <p class="user-select-name">name27 surname27</p>
                                                <span class="text regular">Программист JavaScript</span>
                                            </div>
                                        </div>
                                        <div class="block-head__buttons list-hor">
                                    ...
                                    <main class="attach-block__content block-content">
                                        ...
                                        <div class="block-content__description comment text regular">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                                            Earum id est mollitia odio facilis omnis natus, nostrum officiis 
                                            fuga necessitatibus soluta impedit excepturi, ipsam beatae ullam aliquid 
                                            totam iusto tenetur.
                                        </div>  
                                    </main>
                                </div>
                                <div class="content-wrapper__item files">
                                    <article class="attach-block__content block-content">
                                        <div class="block-content__title title title-block">Файлы</div>
                                        <div class="files-list list-hor flex">
                                            <div class="file list-hor__item" id="152">
                                                <img src="/pictures/icons/file-icons/docx.svg" alt="Курсовой проект - Upgrade.docx" title="Курсовой проект - Upgrade.docx" class="file__icon">
                                                <p class="file__name text" title="Курсовой проект - Upgrade.docx">Ку...ade.docx</p>
                                                <a class="file__download text" href="/php/downloadFile.php?filename=app/uploads/29_Курсовой проект - Upgrade.docx">скачать</a>
                                            </div>
                                            <div class="file list-hor__item" id="152">
                                                <img src="/pictures/icons/file-icons/docx.svg" alt="Курсовой проект - Upgrade.docx" title="Курсовой проект - Upgrade.docx" class="file__icon">
                                                <p class="file__name text" title="Курсовой проект - Upgrade.docx">Ку...ade.docx</p>
                            ...
                            <footer class="attach-block__footer block-footer flex">
                                <div class="block-footer__item attach-block__tags flex list-hor">
                                    <div class="list-hor__item tag" style="background:'.ColoringTagBackground($target[5]).'; color:'.ColoringTagText($target[5]).';">Some project</div>
                                </div>
                                <div class="block-footer__item attach-block__date flex">
                                    <p class="time text regular">14:30</p>
