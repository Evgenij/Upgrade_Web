...
<body>
    ...
    <main class="flex content">
        <img src="pictures/img-reg.svg" alt="img-auth" class="img-auth">
            ...
            <form action="" class="form-reg flex f-col">
                ...
                <div class="row flex">
                    <div class="row__item input-icon icon-smile">
                        <input type="text" name="name" class="input with-icon" id="name" placeholder="введите имя" value="Имя">
                    </div>
                    <input type="text" name="surname" class="row__item input" id="surname" placeholder="введите фамилию" value="Фамилия">
                </div>
                <div class="row flex">
                    ...
                    <select name="specializations" id="specializations" class="custom-select specializations text" placeholder="Специализация">
                        <?php
                            include "vendor/show-spec.php";
                        ?>
                    </select>
                </div>
                <div class="row flex">
                    <div class="row__item input-icon icon-email">
                        <input type="email" name="email" class="input with-icon" id="email" placeholder="введите электронный адрес" value="emailmail.ru">
                    </div>
                </div>
                <div class="row flex">
                    <div class="row__item password input-icon icon-password">
                        <input type="password" name="password" class="input with-icon password-input" id="password" placeholder="введите пароль" value="password">
                        <a href="#" class="password-control flex" onmousedown="mouseDown(this)" onmouseup="mouseUp(this)"></a>
                    </div>
                    <input type="password" name="password_confirm" class="row__item input" id="password_confirm" placeholder="введите пароль повторно" value="пароль-повторно">
                </div>
